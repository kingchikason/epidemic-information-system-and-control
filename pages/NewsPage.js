...
export default class NewsPage extends Component {
    ...
    _openNewsView = (item) =>{
        ...
        this.props.navigation.navigate('NewsView2',{title: item.title, body: item.detail, date: item.published_date, 
            ...
            fetch(url1,{
                ...
                .then((responseJson) =>{ 
                    ...
                    if(type == 'fb'){
                        ...
                        Share.open(options).then((response) => console.log(response))
